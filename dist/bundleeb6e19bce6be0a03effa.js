...
;
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (addToArray);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (cachingDom);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "clickList": () => (/* binding */ clickList),
/* harmony export */   "completeTask": () => (/* binding */ completeTask),
/* harmony export */   "deleteProjectTask": () => (/* binding */ deleteProjectTask),
/* harmony export */   "linkSelection": () => (/* binding */ linkSelection)
/* harmony export */ });
/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./render */ "./src/render.js");
/* harmony import */ var _taskInterface__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./taskInterface */ "./src/taskInterface.js");


var noteWrapper = document.querySelector('.note-wrapper');
var project = document.querySelector('#projectName-wrapper');
var projectName = document.getElementById('projectname');
var addTask = document.querySelector('.addlist');
...
function linkSelection() {
  var _loop = function _loop(i) {
    var _loop2 = function _loop2(j) {
      _render__WEBPACK_IMPORTED_MODULE_0__.allLink[i].addEventListener('click', function (e) {
        e.preventDefault();

        if (i === j) {
          _render__WEBPACK_IMPORTED_MODULE_0__.allDiv[j].style.display = 'block';
        } else {
          _render__WEBPACK_IMPORTED_MODULE_0__.allDiv[j].style.display = 'none';
        }
      });
    };

    for (var j = 0; j < _render__WEBPACK_IMPORTED_MODULE_0__.allDiv.length; j++) {
      _loop2(j);
    }
  };

  for (var i = 0; i < _render__WEBPACK_IMPORTED_MODULE_0__.allLink.length; i++) {
    _loop(i);
  }
}
...
function clickList() {
  function removeBackground() {
    for (var i = 0; i < _render__WEBPACK_IMPORTED_MODULE_0__.allLink.length; i++) {
      _render__WEBPACK_IMPORTED_MODULE_0__.allLink[i].classList.remove('active-list');
    }
  }

  var _loop3 = function _loop3(i) {
    _render__WEBPACK_IMPORTED_MODULE_0__.allLink[i].onclick = function (e) {
      removeBackground();
      _render__WEBPACK_IMPORTED_MODULE_0__.allLink[i].classList.add('active-list');
      (0,_render__WEBPACK_IMPORTED_MODULE_0__.editProjectTask)(); //taskUI.editTask();
    };
  };
...
function deleteProjectTask() {
  var _loop5 = function _loop5(i) {
    _render__WEBPACK_IMPORTED_MODULE_0__.allDiv[i].addEventListener('click', function (e) {
      if (_render__WEBPACK_IMPORTED_MODULE_0__.allDiv[i].style.display !== 'none') {
        if (e.target.classList.contains('delete')) {
          ...
          for (var m = 0; m < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3].length; m++) {
            for (var j = 0; j < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][m].length; j++) {
              if (e.target.parentNode.parentNode === currentChild[j]) {
                ...
                if (i === m + 3) {
                  _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][m].splice(j, 1);
                }
              }
          ...
          (0,_render__WEBPACK_IMPORTED_MODULE_0__.setDataFromLocalStorage)();
  ...
  for (var i = 3; i < _render__WEBPACK_IMPORTED_MODULE_0__.allDiv.length; i++) {
    _loop5(i);
  }
}
...
cancelButton.addEventListener('click', function (e) {
  e.preventDefault();
  projectName.value = 'this is cool as fuck';
  projectContainer.style.display = 'none';
});
console.log(_render__WEBPACK_IMPORTED_MODULE_0__.allLink);
...
/* harmony export */   "allLink": () => (/* binding */ allLink),
/* harmony export */   "editProjectTask": () => (/* binding */ editProjectTask),
/* harmony export */   "newDatas": () => (/* binding */ newDatas),
/* harmony export */   "renderTask": () => (/* binding */ renderTask),
/* harmony export */   "setDataFromLocalStorage": () => (/* binding */ setDataFromLocalStorage)
/* harmony export */ });
...
function getDataFromLocalStorage() {
  if (localStorage.getItem('newList') === null) {
    newDatas = (0,_addlist__WEBPACK_IMPORTED_MODULE_0__["default"])();
  } else {
    newDatas = JSON.parse(localStorage.getItem('newList'));
  }
}

getDataFromLocalStorage(); // Setup localStorage for rendering lists

function setDataFromLocalStorage() {
  var localData = localStorage.setItem('newList', JSON.stringify(newDatas));
}
...
function createProject(index) {
  ...
  var sideEditIcon = document.createElement('img');
  var crossIcon = document.createElement('img');
  var projectLinkName = document.createElement('p');
  projectLinkName.style.marginLeft = '10px';
  newDiv.style.display = 'none';
  newDiv.setAttribute('id', "project".concat(0));
  newLink.setAttribute('id', "projectLink".concat(0));
...
function renderProject() {
  for (var i = 0; i < newDatas[4].length; i++) {
    createProject(i);
  }
}
...
function addNewProject() {
  addButton.addEventListener('click', function (e) {
    ...
    for (var k = 0; k < newDatas[3].length; k++) {
    ...
    isAdded = true;
    (0,_project__WEBPACK_IMPORTED_MODULE_2__.linkSelection)();
    hoverEffect();
    (0,_project__WEBPACK_IMPORTED_MODULE_2__.deleteProjectTask)();
    editProjectTask();
    deleteProject();
    (0,_project__WEBPACK_IMPORTED_MODULE_2__.clickList)();
    ...
    allDiv[i].onclick = function (e) {
      ...
      if (e.target.classList.contains('edit')) {
        ...
        for (var j = 0; j < newDatas[3].length; j++) {
          for (var k = 0; k < newDatas[3][j].length; k++) {
      ...
      confirmButton.onclick = function (e) {
        ...
        for (var l = 0; l < newDatas[3].length; l++) {
          for (var m = 0; m < newDatas[3][l].length; m++) {
            if (i === l + 3) {
            ...
            for (var _j = 0; _j < newDatas[0].length; _j++) {
              if (todoIdForProject === newDatas[0][_j].todoId) {
                console.log(todoIdForProject, newDatas[0][_j].todoId);
                newDatas[0][_j].title = editTitle.value;
                newDatas[0][_j].dueDate = editDate.value;
                newDatas[0][_j].priority = editPriority.value;
                newDatas[0][_j].textArea = editTextArea.value;
              }
            }

            for (var _k = 0; _k < newDatas[1].length; _k++) {
              if (todoIdForProject === newDatas[1][_k].todoId) {
                console.log(todoIdForProject, newDatas[1][_k].todoId);
                newDatas[1][_k].title = editTitle.value;
                newDatas[1][_k].dueDate = editDate.value;
                newDatas[1][_k].priority = editPriority.value;
                newDatas[1][_k].textArea = editTextArea.value;
              }
            }

            for (var _k2 = 0; _k2 < newDatas[2].length; _k2++) {
              if (todoIdForProject === newDatas[2][_k2].todoId) {
                console.log(todoIdForProject, newDatas[2][_k2].todoId);
                newDatas[2][_k2].title = editTitle.value;
                newDatas[2][_k2].dueDate = editDate.value;
                newDatas[2][_k2].priority = editPriority.value;
                newDatas[2][_k2].textArea = editTextArea.value;
              }
            }
          }
...
editProjectTask(); // function editProjectTask2() {
...
function deleteProject() {
  var _loop3 = function _loop3(i) {
    selectCrossButton[i].onclick = function () {
      for (var m = 0; m < newDatas[3][i].length; m++) {
        for (var l = 0; l < newDatas[0].length; l++) {
          if (newDatas[0][l].todoId === newDatas[3][i][m].todoId) {
            newDatas[0].splice(l, 1);
          }
        }

        for (var _l = 0; _l < newDatas[1].length; _l++) {
          if (newDatas[1][_l].todoId === newDatas[3][i][m].todoId) {
            newDatas[1].splice(_l, 1);
          }
        }

        for (var _l2 = 0; _l2 < newDatas[2].length; _l2++) {
          if (newDatas[2][_l2].todoId === newDatas[3][i][m].todoId) {
            newDatas[2].splice(_l2, 1);
          }
        }
      }

      newDatas[3].splice(i, 1); // newDatas[3].splice(i, 0, i);

      newDatas[4].splice(i, 1);
      console.log(newDatas[4]);
      setDataFromLocalStorage(); // Delete link when click the cross button
...
function createTask(outerIndex, innerIndex) {
  ...
  var week = document.getElementById('week'); //creating new Div element that will contain task details
  ...
  var newSpanPriority = document.createElement('span');
  var newSpanDate = document.createElement('span');
  var newSpanEdit = document.createElement('span');
  var newSpanDelete = document.createElement('img'); //const deleteIcon = document.createElement('img');
  ...
  newSpanDate.textContent = "".concat(newDatas[outerIndex][innerIndex].dueDate);
  ...
  inbox.appendChild(newDiv); // controlling which task to go where 
    ...
    for (var i = 3; i < allDiv.length; i++) {
      for (var k = 0; k < newDatas[3][innerIndex].length; k++) {
        if (i === innerIndex + 3) {
          ...
          var newSpanDate = document.createElement('span');
          var newSpanEdit = document.createElement('span');
          var newSpanDelete = document.createElement('img'); //adding class to each element
...
function renderTask() {
  var tasks = document.querySelectorAll('.list-wrapper');
  tasks.forEach(function (task) {
    task.remove();
  });

  for (var i = 0; i < newDatas.length - 2; i++) {
    for (var j = 0; j < newDatas[i].length; j++) {
      createTask(i, j);
    }
  ...
  for (var _i = 3; _i < newDatas.length; _i++) {
    for (var _j2 = 0; _j2 < newDatas[_i].length; _j2++) {
      createProjectTask(_i, _j2);
    }
...
(function addTask() {
  ...
  addButtons.addEventListener('click', function (e) {
    e.preventDefault();
    var date = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])();
    var weeksDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(date, 8); // get next week's date to compare with user's selected date

    var newList = (0,_task__WEBPACK_IMPORTED_MODULE_1__["default"])(); // create new to do list when user clicks on the button

    newDatas[0].push(newList); // pushing any data the user add

    date = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(date, 'yyyy-MM-dd');
    weeksDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(weeksDate, 'yyyy-MM-dd');
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _domCaching__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domCaching */ "./src/domCaching.js");


function List() {
  // Instantiate domCaching function with destructuring method
  var _domCaching = (0,_domCaching__WEBPACK_IMPORTED_MODULE_0__["default"])(),
      todoId = _domCaching.todoId,
      date = _domCaching.date,
      priority = _domCaching.priority,
      textArea = _domCaching.textArea,
      title = _domCaching.title;
...
var taskEditor = document.querySelector('.task-container');
var crossButton = document.querySelector('.cross');
var crossButton2 = document.querySelector('.cross2');
var addTask = document.querySelector('#addtolist');
var title = document.querySelector('#title');
var description = document.querySelector('#description');
var date = document.querySelector('#date'); //addNewProject();
...
var taskUI = function () {
  function deleteTask() {
          ...
          if (i === 0) {
              ...
              if (e.target.parentNode.parentNode === currentChild[_i]) {
                ...
                for (var l = 0; l < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3].length; l++) {
                  for (var m = 0; m < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][l].length; m++) {
                    if (_render__WEBPACK_IMPORTED_MODULE_0__.newDatas[0][_i].todoId === _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][l][m].todoId) {
                      _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][l].splice(m, 1);
                    }
                  }
                }
            ...
            for (var _i2 = 0; _i2 < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[1].length; _i2++) {
              if (e.target.parentNode.parentNode === currentChild[_i2]) {
                ...
                for (var _l = 0; _l < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3].length; _l++) {
                  for (var _m = 0; _m < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l].length; _m++) {
                    if (_render__WEBPACK_IMPORTED_MODULE_0__.newDatas[1][_i2].todoId === _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l][_m].todoId) {
                      _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l].splice(_m, 1);
                    }
                  }
                }
            ...
            for (var _i3 = 0; _i3 < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[2].length; _i3++) {
              if (e.target.parentNode.parentNode === currentChild[_i3]) {
                ...
                for (var _l2 = 0; _l2 < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3].length; _l2++) {
                  for (var _m2 = 0; _m2 < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l2].length; _m2++) {
                    if (_render__WEBPACK_IMPORTED_MODULE_0__.newDatas[2][_i3].todoId === _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l2][_m2].todoId) {
                      _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l2].splice(_m2, 1);
                    }
                  }
                }
    ...
    for (var i = 0; i < _render__WEBPACK_IMPORTED_MODULE_0__.allDiv.length; i++) {
      _loop(i);
    }
  }
  ...
  function editTask() {
    ...
    var _loop2 = function _loop2(i) {
      _render__WEBPACK_IMPORTED_MODULE_0__.allDiv[i].onclick = function (e) {
        if (e.target.classList.contains('edit')) {
          taskAdder.style.display = 'flex';
          var currentChild = e.target.parentNode.parentNode.parentNode.childNodes;
          ...
          if (i === 0) {
            for (var _i4 = 0; _i4 < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[0].length; _i4++) {
              if (e.target.parentNode.parentNode === currentChild[_i4]) {
                ...
                todoId = _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[0][_i4].todoId;
                console.log("Hi!"); // Adding edited data when user clicks on confirm button
              }
            }
          } else if (i === 1) {
            for (var _i5 = 0; _i5 < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[1].length; _i5++) {
              if (e.target.parentNode.parentNode === currentChild[_i5]) {
                ...
                todoId = _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[1][_i5].todoId;
              }
            }
          } else if (i === 2) {
        ...
        confirmButton.onclick = function (e) {
          ...
          if (i === 0) {
            for (var j = 0; j < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[0].length; j++) {
              ...
              for (var l = 0; l < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3].length; l++) {
                for (var m = 0; m < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][l].length; m++) {
                  if (todoId === _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][l][m].todoId) {
                    ...
                    console.table(todoId, _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][l][m].todoId, _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][l], _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][l][m]);
                  }
                }
              }
            }
            ...
            for (var _j3 = 0; _j3 < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[1].length; _j3++) {
              ...
              for (var _k2 = 0; _k2 < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[0].length; _k2++) {
                if (todoId === _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[0][_k2].todoId) {
                  console.log(todoId, _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[0][_k2].todoId);
                  _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[0][_k2].title = editTitle.value;
                  _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[0][_k2].dueDate = editDate.value;
                  _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[0][_k2].priority = editPriority.value;
                  _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[0][_k2].textArea = editTextArea.value;
                }
              }

              for (var _l3 = 0; _l3 < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3].length; _l3++) {
                for (var _m3 = 0; _m3 < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l3].length; _m3++) {
                  if (todoId === _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l3][_m3].todoId) {
                    _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l3][_m3].title = editTitle.value;
                    _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l3][_m3].dueDate = editDate.value;
                    _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l3][_m3].priority = editPriority.value;
                    _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l3][_m3].textArea = editTextArea.value;
                    console.table(todoId, _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l3][_m3].todoId, _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l3], _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l3][_m3]);
                  }
                }
              }
            }
            ...
            for (var _j4 = 0; _j4 < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[2].length; _j4++) {
              ...
              for (var _l4 = 0; _l4 < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3].length; _l4++) {
                for (var _m4 = 0; _m4 < _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l4].length; _m4++) {
                  if (todoId === _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l4][_m4].todoId) {
                    _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l4][_m4].title = editTitle.value;
                    _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l4][_m4].dueDate = editDate.value;
                    _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l4][_m4].priority = editPriority.value;
                    _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l4][_m4].textArea = editTextArea.value;
                    console.table(todoId, _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l4][_m4].todoId, _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l4], _render__WEBPACK_IMPORTED_MODULE_0__.newDatas[3][_l4][_m4]);
                  }
                }
              }
            }
...
/* harmony import */ var _taskInterface__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./taskInterface */ "./src/taskInterface.js");
...
(0,_project__WEBPACK_IMPORTED_MODULE_3__.completeTask)();
})();

/******/ })()
;
//# sourceMappingURL=bundleeb6e19bce6be0a03effa.js.map